...
> Low-level software design, autonomous agent behavior modeling, mathematical physics, and real-time game state management in a pure, zero-dependency environment.

### Autonomy & Decision Systems
